...
} from "./reducers/NewFilmInfoSlice";

export const getNewFilmInfo = async (id) => {
  const optionsAka = {
    method: "GET",
...
export const getNewFilmInfoRedux = (id) => {
  return async (dispatch) => {
    try {
      dispatch(getNewFilmInfoIsLoading());
      ...
      dispatch(getNewFilmInfoSuccess(response));
    } catch (e) {
      dispatch(getNewFilmInfoError(e.message));
    }
  };
};
